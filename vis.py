...
print("Dataset generated and saved as 'high_quality_crime_data.csv'")
...
for i, feature in enumerate(['latitude', 'longitude', 'victim_age', 'hour']):
    plt.subplot(2, 2, i + 1)
...
data = pd.read_csv('high_quality_crime_data.csv')

# Create a 'date' column from 'year' and 'month' for better handling
...
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='Blues',
            xticklabels=label_encoders['crime_type'].classes_,
            yticklabels=label_encoders['crime_type'].classes_)
...
future_data = future_data[['latitude', 'longitude', 'victim_age', 'victim_gender', 'victim_ethnicity', 'weather', 'day_night', 'hour', 'day_of_week', 'month', 'year']]
